...
df_control = pd.read_csv(file_path_control)
...
df_data["Tx_lb_in"] = df_data["Tx"] * 0.224809 * 12 - 8
df_data["Ty_lb_in"] = df_data["Ty"] * 0.224809 * 12 + 78
df_data["Tz_lb_in"] = df_data["Tz"] * 0.224809 * 12 - 25

df_control["Tx_lb_in"] = df_control["Tx"] * 0.224809 * 12 - 8 
df_control["Ty_lb_in"] = df_control["Ty"] * 0.224809 * 12 + 78
df_control["Tz_lb_in"] = df_control["Tz"] * 0.224809 * 12 - 25 + 17
...
def update(val):
    ...
    # Update lines for forces and moments
    line_fx_data.set_data(df_data.index[start_index:end_index], df_data["Fx_lb"][start_index:end_index])
    line_fy_data.set_data(df_data.index[start_index:end_index], df_data["Fy_lb"][start_index:end_index])
    line_fz_data.set_data(df_data.index[start_index:end_index], df_data["Fz_lb"][start_index:end_index])
    
    line_fx_control.set_data(df_control.index[start_index:end_index], df_control["Fx_lb"][start_index:end_index])
    line_fy_control.set_data(df_control.index[start_index:end_index], df_control["Fy_lb"][start_index:end_index])
    line_fz_control.set_data(df_control.index[start_index:end_index], df_control["Fz_lb"][start_index:end_index])
    
    line_tx_data.set_data(df_data.index[start_index:end_index], df_data["Tx_lb_in"][start_index:end_index])
    line_ty_data.set_data(df_data.index[start_index:end_index], df_data["Ty_lb_in"][start_index:end_index])
    line_tz_data.set_data(df_data.index[start_index:end_index], df_data["Tz_lb_in"][start_index:end_index])
    
    line_tx_control.set_data(df_control.index[start_index:end_index], df_control["Tx_lb_in"][start_index:end_index])
    line_ty_control.set_data(df_control.index[start_index:end_index], df_control["Ty_lb_in"][start_index:end_index])
    line_tz_control.set_data(df_control.index[start_index:end_index], df_control["Tz_lb_in"][start_index:end_index])
